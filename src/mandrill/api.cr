module Mandrill
  class Templates
    ...
    def add(name, from_email = nil, from_name = nil, subject = nil, code = nil, text = nil, publish = true, labels = [] of String)
      _params = {:key => @master.key, :name => name, :from_email => from_email, :from_name => from_name, :subject => subject, :code => code, :text => text, :publish => publish, :labels => labels}
    ...
    #     - [String] updated_at the date and time the template was last modified as a UTC string in YYYY-MM-DD HH:MM:SS format
    def info(name)
      _params = {:key => @master.key, :name => name}
    ...
    #         - [String] updated_at the date and time the template was last modified as a UTC string in YYYY-MM-DD HH:MM:SS format
    def list(label = nil)
      _params = {:key => @master.key, :label => label}
    ...
    def render(template_name, template_content, merge_vars = nil)
      _params = {:key => @master.key, :template_name => template_name, :template_content => template_content, :merge_vars => merge_vars}
  ...
  class Rejects
    ...
    def add(email, comment = nil, subaccount = nil)
      _params = {:key => @master.key, :email => email, :comment => comment, :subaccount => subaccount}
    ...
    def list(email = nil, include_expired = false, subaccount = nil)
      _params = {:key => @master.key, :email => email, :include_expired => include_expired, :subaccount => subaccount}
    ...
    def delete(email, subaccount = nil)
      _params = {:key => @master.key, :email => email, :subaccount => subaccount}
  ...
  class Inbound
    ...
    def add_domain(domain)
      _params = {:key => @master.key, :domain => domain}
    ...
    def add_route(domain, pattern, url)
      _params = {:key => @master.key, :domain => domain, :pattern => pattern, :url => url}
    ...
    def update_route(id, pattern = nil, url = nil)
      _params = {:key => @master.key, :id => id, :pattern => pattern, :url => url}
    ...
    def send_raw(raw_message, to = nil, mail_from = nil, helo = nil, client_address = nil)
      _params = {:key => @master.key, :raw_message => raw_message, :to => to, :mail_from => mail_from, :helo => helo, :client_address => client_address}
  ...
  class Tags
    ...
    #     - [Integer] unique_clicks the number of unique clicks for emails sent with this tag
    def delete(tag)
      _params = {:key => @master.key, :tag => tag}
  ...
  class Whitelists
    ...
    def add(email, comment = nil)
      _params = {:key => @master.key, :email => email, :comment => comment}
    ...
    def list(email = nil)
      _params = {:key => @master.key, :email => email}
  ...
  class Ips
    ...
    def provision(warmup = false, pool = nil)
      _params = {:key => @master.key, :warmup => warmup, :pool => pool}
    ...
    def set_pool(ip, pool, create_pool = false)
      _params = {:key => @master.key, :ip => ip, :pool => pool, :create_pool => create_pool}
    ...
    #                 - [String] end_at the end date and time for the warmup process as a UTC string in YYYY-MM-DD HH:MM:SS format
    def pool_info(pool)
      _params = {:key => @master.key, :pool => pool}
    ...
    def check_custom_dns(ip, domain)
      _params = {:key => @master.key, :ip => ip, :domain => domain}
  ...
  class Subaccounts
    ...
    def add(id, name = nil, notes = nil, custom_quota = nil)
      _params = {:key => @master.key, :id => id, :name => name, :notes => notes, :custom_quota => custom_quota}
  ...
  class Urls
    ...
    def time_series(url)
      _params = {:key => @master.key, :url => url}
  ...
  class Webhooks
    ...
    def add(url, description = nil, events = [] of String)
      _params = {:key => @master.key, :url => url, :description => description, :events => events}
    ...
    def update(id, url, description = nil, events = [] of String)
      _params = {:key => @master.key, :id => id, :url => url, :description => description, :events => events}
  ...
  class Senders
    ...
    def verify_domain(domain, mailbox)
      _params = {:key => @master.key, :domain => domain, :mailbox => mailbox}
    ...
    def info(address)
      _params = {:key => @master.key, :address => address}
  ...
  class Metadata
    ...
    def add(name, view_template = nil)
      _params = {:key => @master.key, :name => name, :view_template => view_template}
  ...
  class Exports
    ...
    def rejects(notify_email = nil)
      _params = {:key => @master.key, :notify_email => notify_email}
    ...
    def activity(notify_email = nil, date_from = nil, date_to = nil, tags = nil, senders = nil, states = nil, api_keys = nil)
      _params = {:key => @master.key, :notify_email => notify_email, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders, :states => states, :api_keys => api_keys}
  ...
  class Messages
    ...
    def send(message, async = false, ip_pool = nil, send_at = nil)
      _params = {:key => @master.key, :message => message, :async => async, :ip_pool => ip_pool, :send_at => send_at}
      return @master.call "messages/send", _params.to_json
    end
    ...
    def send_template(template_name, template_content, message, async = false, ip_pool = nil, send_at = nil)
      _params = {:key => @master.key, :template_name => template_name, :template_content => template_content, :message => message, :async => async, :ip_pool => ip_pool, :send_at => send_at}
    ...
    def search(query = '*', date_from = nil, date_to = nil, tags = nil, senders = nil, api_keys = nil, limit = 100)
      _params = {:key => @master.key, :query => query, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders, :api_keys => api_keys, :limit => limit}
    ...
    def search_time_series(query = '*', date_from = nil, date_to = nil, tags = nil, senders = nil)
      _params = {:key => @master.key, :query => query, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders}
    ...
    def parse(raw_message)
      _params = {:key => @master.key, :raw_message => raw_message}
    ...
    def send_raw(raw_message, from_email = nil, from_name = nil, to = nil, async = false, ip_pool = nil, send_at = nil, return_path_domain = nil)
      _params = {:key => @master.key, :raw_message => raw_message, :from_email => from_email, :from_name => from_name, :to => to, :async => async, :ip_pool => ip_pool, :send_at => send_at, :return_path_domain => return_path_domain}
    ...
    def reschedule(id, send_at)
      _params = {:key => @master.key, :id => id, :send_at => send_at}
